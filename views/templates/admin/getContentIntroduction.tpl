...
<form method="POST" action="{$EMC_link|escape:'htmlall'}&EMC_tab=merchant">
	<fieldset id="introduction">
		...
		<p class="important"><a target="_blank" href="http://ecommerce.envoimoinscher.com/landing/prestashop/?utm_source=prestashop&utm_medium=partner&utm_campaign=201409_landing">{l s='Create your free account and get your API key' mod='envoimoinscher'}</a></p>
