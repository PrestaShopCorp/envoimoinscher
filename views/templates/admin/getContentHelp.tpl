...
<fieldset id="EMC_help">
		...
		<div >
			<div>
				<div class="openable-title closed">
					<div class="title">
						<p>
							<img src="{$emcBaseDir}img/arrow_right.png" class="imgSwitchFaq" class="imgSwitchFaq" alt="clic to switch">
				...
				<div class="openable-title closed">
					<div class="title">
						<p>
							<img src="{$emcBaseDir}img/arrow_right.png" class="imgSwitchFaq" alt="clic to switch">
	...
	<script src="{$emcBaseDir|escape:'htmlall':'UTF-8'}js/getcontenthelp.js" type="text/javascript"></script>
	</div>
