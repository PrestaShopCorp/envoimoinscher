 ...
 * versions in the future. If you wish to customize PrestaShop for youry
 ...
 *}
	...
	<script type="text/javascript" src="{$baseDir|escape:'htmlall':'UTF-8'}modules/envoimoinscher/views/js/ordersFilter.js"></script>
	...
	<div class="bootstrap">
		...
		<div class="panel">
			...
			<form id="orderDo" method="post" action="index.php?controller=AdminEnvoiMoinsCher&option=initOrder&token={$token|escape:'htmlall':'UTF-8'}">
				<div>
